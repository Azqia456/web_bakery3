...
<head>
    ...
    <title>Three D Bakery - Lupa Kata Sandi</title>
        ...
        <div class="reset-section">
            <div class="form-container">
                <div class="form-header">
                    ...
                    <p>Masukkan email Anda dan kami akan mengirimkan kode OTP untuk mereset kata sandi.</p>
                </div>
                ...
                <form id="forgotPasswordForm" method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="Masukkan email Anda" required value="{{ old('email') }}" autofocus>
                        @error('email')
