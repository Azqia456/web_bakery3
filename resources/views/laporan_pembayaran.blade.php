...
<head>
    ...
    <title>Laporan Pembayaran - Three D Bakery</title>
...
<body>
    <div class="dashboard">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="sidebar-menu-item">
                    ...
                    <div class="sidebar-submenu">
                        ...
                        <a href="/laporan-pembayaran" class="sidebar-submenu-item active">Laporan Pembayaran</a>
        ...
        <div class="main-content">
            @include('layouts.header', ['title' => '💳 Laporan Pembayaran', 'showSearch' => false, 'showAddButton' => false, 'totalNotifikasi' => 0])
