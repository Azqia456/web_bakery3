...
<head>
    ...
    <title>Laporan Penjualan - Three D Bakery</title>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="sidebar-menu-item">
                    ...
                    <div class="sidebar-submenu">
                        <a href="/laporan-penjualan" class="sidebar-submenu-item active">Laporan Penjualan</a>
            ...
            <div class="page-container">
                <div class="content-card">
                    <div class="empty-state">
                        ...
                        <p>Laporan penjualan produk bakery akan ditampilkan di sini.</p>
                        <p style="margin-top: 16px; font-size: 12px; color: #999;">
                            Fitur laporan penjualan masih dalam tahap pengembangan.
                        </p>
                    </div>
                </div>
            </div>
