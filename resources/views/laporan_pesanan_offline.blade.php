            ...
            <div class="page-container">
                ...
                <div style="margin-bottom: 32px;">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                        <i class="fas fa-store" style="font-size: 28px; color: #6f42c1;"></i>
                        <h2 style="margin: 0; color: #333; font-weight: 700; font-size: 28px;">Laporan Pesanan Offline</h2>
                    </div>
                    <p style="margin: 0; color: #6c757d; font-size: 14px;">🏪 Monitoring transaksi pembelian langsung di bakery</p>
                </div>
