            ...
            <div class="page-container">
                <div class="content-card">
                    <div class="empty-state">
                        ...
                        <h2>Laporan Pesanan Online</h2>
                        <p>Laporan pesanan online yang diterima dari pelanggan akan ditampilkan di sini.</p>
                        <p style="margin-top: 16px; font-size: 12px; color: #999;">
                            Fitur laporan pesanan online masih dalam tahap pengembangan.
                        </p>
                    </div>
                </div>
            </div>
