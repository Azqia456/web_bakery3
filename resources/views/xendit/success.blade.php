...
<head>
    ...
    <title>Pembayaran Berhasil - Three D Bakery</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .meta { background: #f8f9fa; border-radius: 10px; padding: 16px; margin-bottom: 24px; font-size: 13px; color: #6c757d; }
...
<body>
    <div class="card">
        ...
        <p>Terima kasih, pembayaran Anda telah berhasil diverifikasi. Pesanan Anda akan segera diproses.</p>
        @if($externalId)
        <div class="meta">ID Transaksi: <strong>{{ $externalId }}</strong></div>
        @endif
